...
$(document).ready(function(){
  ...
  $("#idmata_pelajaran").on("change", function( ) {
    ...
    $.ajax({
        ...
        url: base_url+"Rencana_pengetahuan/check_ph",
        success: function(r) {
            if (r.status == "y") {
              $('#jumlah_ph').val(r.data.rkdp_penilaian_harian);
              $('#divPengetahuan').fadeIn();
              fDatatables("tPengetahuan","<?=base_url('guru/Rencana_pengetahuan/ajax_list/')?>"+idmata_pelajaran+"/"+idkelas,"ASC");
            } else if (r.status == "n") {
              $('#jumlah_ph').val(r.data.rkdp_penilaian_harian);
              $('#divPengetahuan').fadeOut();
            }
  ...
  $("#jumlah_ph").on("change", function( ) {
    ...
    if(formValidation()){
      ...
      $.ajax({
          ...
          url: base_url+"Rencana_pengetahuan/save",
          success: function(r) {
              if (r.status == "update") {
...
$(document).delegate("#kd_status","click",function( ) {
  ...
  $.ajax({
      ...
      url: base_url+"Rencana_pengetahuan/update_status",
      success: function(r) {
          if (r.status == "gagal") {

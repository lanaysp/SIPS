        ...
        <div class="row" id="info-data">
          <div class="col-lg-4 col-6">
            <div class="small-box bg-primary">
              ...
              <a href="<?=base_url('guru/nilai_akhir/')?>" class="small-box-footer">Radar Nilai Rapor <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-6">
            <div class="small-box bg-primary">
              ...
              <a href="<?=base_url('guru/deskripsi_siswa/')?>" class="small-box-footer">Proses Deskripsi Siswa <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-6">
            <div class="small-box bg-primary">
              ...
              <a href="<?=base_url('guru/kompetensi_dasar/')?>" class="small-box-footer">Data Kompetensi Dasar <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
...
<script type="text/javascript">
  $('#modal_corona').on('show.bs.modal', function () { 
    ...
    $.ajax({
      url: "<?=base_url('guru/Dashboard/corona/')?>",
      type: "post",

            ...
            <div class="card card-primary card-outline" style="border-top:3px solid #2D5E89;">
              <div class="card-body box-profile">
                <div class="text-center">
                  <a href="<?=base_url('assets/upload/administrator/')?><?=$u_photo?>" data-toggle="lightbox" data-title="<?=$u_photo?>">
                  <img class="profile-user-img img-fluid img-circle"
                       src="<?=base_url('assets/upload/administrator/thumbnails/')?><?=$u_photo?>"
          ...
          <div class="col-lg-8">
            ...
            <div class="card card-primary card-tabs">
              <div class="card-header" style="background-color:#2D5E89;">
                <i class="fas fa-edit"></i> <span>Data Pengguna Admin</span>
              </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="background-color:#293D55; color:white;">
          <h6 class="modal-title">[Ubah Profil Administrator]</h6>
                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="u_nama_akhir" class="form-control" id="u_nama_akhir" placeholder="<?=$u_nama_akhir?>" value="<?=$u_nama_akhir?>" required="">
                        </div>
                        <div class="form-group">
                      ...
                      <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                              ...
                              <?php
                                  echo "<img style='max-width:60%;' data-image='$u_photo' src='".base_url('assets/upload/administrator/')."$u_photo' class='thumb img-responsive current-img-remove'> ";
                              ?>
                            </div>
                        </div>
                      </div>
                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="u_status" class="form-control" id="u_status" value="administrator" required>
                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="d_tahun" class="form-control" id="d_tahun" placeholder="<?=date('Y')?>" value="" required>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  function formValidationData()
  {
    ...
    if ($.trim(u_nama_awal)==''){
    ...
    } else if ($.trim(u_nama_akhir)==''){
      showToast('Nama akhir tidak boleh kosong !',1000,'error');
      ...
      $(".error-message12").append('<div class="font-italic text-danger" id="error-message12"><small>* silahkan isi sesuai format yang diminta</small></div>');
    } else if ($.trim(u_sertifikasi)=='Sudah' && $.trim(u_sertifikasi_tahun)==''){
  ...
  function edit_diklat(id)
  {
    ...
    $.ajax({
        type: "GET",
        url: base_url+"Data/edit_diklat/"+id,
  ...
  function edit_mapel(id)
  {
    ...
    $.ajax({
        type: "GET",
        url: base_url+"Data/edit_mapel/"+id,
        success: function(result) {
  ...
  function edit_kelas(id)
  {
    ...
    $.ajax({
        type: "GET",
        url: base_url+"Data/edit_kelas/"+id,
        success: function(result) {
  ...
  function delete_diklat(id,data) {
    ...
    if (confirm('Apakah anda yakin ingin menghapus diklat '+data+'..? ')) {
      $.ajax({
      type: "GET",
      url: base_url+"Data/delete_diklat/"+id,
      success: function(r) {
        if (r.status == 'ok'){
  ...
  function delete_mapel(id,data) {
    ...
    if (confirm('Apakah anda yakin ingin menghapus mata pelajaran '+data+'..? ')) {
      $.ajax({
      type: "GET",
      url: base_url+"Data/delete_mapel/"+id,
      success: function(r) {
        if (r.status == 'ok'){
          showToast('Data berhasil dihapus !',1000,'success');
          $("#refresh_content").load(" #refresh");
  ...
  function delete_kelas(id,data) {
    ...
    if (confirm('Apakah anda yakin ingin menghapus kelas '+data+'..? ')) {
      $.ajax({
      type: "GET",
      url: base_url+"Data/delete_kelas/"+id,
      success: function(r) {
        if (r.status == 'ok'){
          showToast('Data berhasil dihapus !',1000,'success');
          $("#refresh_content").load(" #refresh");

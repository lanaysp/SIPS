                          ...
                          <div class="card-body table-responsive">
                            <table id="tRincian" class="table table-bordered table-striped">
                              <div class="float-right">
                                ...
                                <small><i>* Simbol (..) berarti kriteria nilai kolom tersebut seperti kkm atau interval predikat masih kosong dan belum diinput oleh administrator</i></small>
                              </div>
...
<script type="text/javascript">
    ...
    $('#modal_show_chart').on('show.bs.modal', function () {
      ...
      $.ajax({
        url: "<?=base_url('walikelas/Nilai_akhir/nilai_siswa_chart/')?>",
        type: "post",
    ...
    $('#modal_show_all_chart').on('show.bs.modal', function () {
      ...
      var token = 'access';
      $.ajax({
        url: "<?=base_url('walikelas/Nilai_akhir/nilai_seluruh_siswa_chart/')?>",
        type: "post",
    ...
    $(document).ready(function(){
        $("#idkelas").on("change", function( ) {
            ...
            $('#divAkhir').fadeIn();
            fDatatables("tRincian","<?=base_url('walikelas/Nilai_akhir/ajax_list/')?>"+idkelas,"ASC");
            return false;
            };
        });

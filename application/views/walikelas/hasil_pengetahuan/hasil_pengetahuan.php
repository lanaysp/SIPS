...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#idmata_pelajaran").on("change", function( ) {
            ...
            fDatatables("tRincian","<?=base_url('walikelas/Hasil_pengetahuan/ajax_list_rincian/')?>"+idkelas+"/"+idmata_pelajaran,"ASC");
            fDatatables("tPengolahan","<?=base_url('walikelas/Hasil_pengetahuan/ajax_list_pengolahan/')?>"+idkelas+"/"+idmata_pelajaran,"ASC");
            fDatatables("tRapor","<?=base_url('walikelas/Hasil_pengetahuan/ajax_list_rapor/')?>"+idkelas+"/"+idmata_pelajaran,"ASC");
            return false;
            };
        });

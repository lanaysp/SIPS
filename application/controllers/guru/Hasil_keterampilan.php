...
class Hasil_keterampilan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('guru/template','guru/hasil_keterampilan/hasil_keterampilan',$this->data);
    }
    ...
    public function ajax_list_rincian()
	{
        ...
        $list = $this->Model_keterampilan->get_datatables_siswa($idkelas,$this->session->userdata('tahun'),$this->session->userdata('user_id'));
		...
		foreach ($list as $data_deskripsi) {
            ...
            if ($keterampilan!=false){
                ...
                {   
                    ...
                    $total_kd_nk = $total_kd_nk + $total_rata_kd;
                    $total_kd = 0;
                }
            }
    ...
    public function ajax_list_rapor()
	{
		...
		foreach ($list as $data_deskripsi) {
            ...
            if ($keterampilan!=false){
                ...
                $rata_kd_k = ceil($total_kd_nk / $kd);  
            } else {
                $rata_kd_k = 0;
            }

            // Menghitung nilai akhir
            $na_keterampilan = $rata_kd_k;

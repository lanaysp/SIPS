...
class Nilai_akhir extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('guru/template','guru/nilai_akhir/nilai_akhir',$this->data);
    }
		...
		foreach ($list as $data_nilai_akhir) {
            ...
            if ($mapel!=false){
                foreach ($mapel as $m_row){
                    ...
                    $pengetahuan = $this->Model_pengetahuan->read_data_siswa($data_nilai_akhir->idsiswa,$idkelas,$idmapel,$this->session->userdata('tahun'),$this->session->userdata('user_id'));
                    $pengetahuan_utsuas = $this->Model_pengetahuan_utsuas->read_data_siswa($data_nilai_akhir->idsiswa,$idkelas,$idmapel,$this->session->userdata('tahun'),$this->session->userdata('user_id'));
                    $keterampilan = $this->Model_keterampilan->read_data_siswa($data_nilai_akhir->idsiswa,$idkelas,$idmapel,$this->session->userdata('tahun'),$this->session->userdata('user_id'));
    ...
    public function nilai_siswa_chart()
    {
        ...
        $this->load->view('guru/nilai_akhir/nilai_siswa_chart',$this->data);
    }
    ...
    public function nilai_seluruh_siswa_chart()
    {
        ...
        $this->load->view('guru/nilai_akhir/nilai_seluruh_siswa_chart',$this->data);
    }
